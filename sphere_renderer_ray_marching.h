...
namespace cgv { // @<
	namespace render { // @<
		...
		extern /*CGV_API*/ sphere_renderer_ray_marching& ref_sphere_renderer_ray_marching(context& ctx, int ref_count_change = 0);

		/** render style for sphere rendere */
		struct /*CGV_API*/ sphere_render_ray_marching_style : public surface_render_style
		{
		...
		class /*CGV_API*/ sphere_renderer_ray_marching : public surface_renderer
		{
		protected:
			bool has_radii;
		...
		struct /*CGV_API*/ sphere_render_ray_marching_style_reflect : public sphere_render_ray_marching_style
		{
			bool self_reflect(cgv::reflect::reflection_handler& rh);
		};
		extern /*CGV_API*/ cgv::reflect::extern_reflection_traits<sphere_render_ray_marching_style, sphere_render_ray_marching_style_reflect> get_reflection_traits(const sphere_render_ray_marching_style&);
	}
}

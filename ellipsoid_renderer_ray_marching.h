...
namespace cgv { // @<
	namespace render { // @<
		class ellipsoid_renderer_ray_marching;
		...
		extern ellipsoid_renderer_ray_marching& ref_ellipsoid_renderer_ray_marching(context& ctx, int ref_count_change = 0);

		/** render style for ellipsoid rendere */
		struct ellipsoid_render_ray_marching_style : public surface_render_style
		{
			...
			ellipsoid_render_ray_marching_style();
		};

		/// renderer that supports splatting of ellipsoids
		class  ellipsoid_renderer_ray_marching : public surface_renderer
		{
		protected:
			bool has_sizes;
		...
		public:
			///
			ellipsoid_renderer_ray_marching();
		...
		struct  ellipsoid_render_ray_marching_style_reflect : public ellipsoid_render_ray_marching_style
		{
			bool self_reflect(cgv::reflect::reflection_handler& rh);
		};
		extern  cgv::reflect::extern_reflection_traits<ellipsoid_render_ray_marching_style, ellipsoid_render_ray_marching_style_reflect> get_reflection_traits(const ellipsoid_render_ray_marching_style&);
	}
}

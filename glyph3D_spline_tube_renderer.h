...
namespace cgv { // @<
	namespace render { // @<
		...
		extern glyph3D_spline_tube_renderer& ref_glyph3D_spline_tube_renderer(context& ctx, int ref_count_change = 0);

		/*!	Style to control the look of glyph3D spline tubes. */
		struct glyph3D_spline_tube_render_style : public glyph3D_render_style
		{
		...
		class glyph3D_spline_tube_renderer : public glyph3D_renderer
		{
		protected:

...
protected:
	...
	struct {
		...
		glyph3D_spline_tube_render_style style;
	...
	struct {
		...
		struct {
			...
			glyph3D_spline_tube_render_style::LinePrimitive last_tube_primitive = glyph3D_spline_tube_render_style::LP_TUBE_RUSSIG;
			...
			glyph3D_spline_tube_render_style::LinePrimitive last_ribbon_primitive = glyph3D_spline_tube_render_style::LP_RIBBON_RAYCASTED;
